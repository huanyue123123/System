...
public class SendMessageUtil {
     ...
     */
    public static Integer send(SendMessagePropertis prop){
        ...
        //设置参数
        NameValuePair[] data = {
                new NameValuePair("Uid", prop.getAccount()),
                new NameValuePair("Key", prop.getKey()),//秘钥
                new NameValuePair("smsMob", prop.getAimPhone()),
                new NameValuePair("smsText", prop.getContent())
        };
