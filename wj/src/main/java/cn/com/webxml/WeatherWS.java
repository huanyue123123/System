 ...
 * 
 */
@WebServiceClient(name = "WeatherWS", targetNamespace = "http://WebXml.com.cn/", wsdlLocation = "file:/F:/git-repos/wj/src/main/resources/WeatherWS.xml")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/F:/git-repos/wj/src/main/resources/WeatherWS.xml");
